...
//hacks
const pkgOption = require('webpack-custom-plugin/lib/check-pkg-option');
...
module.exports = class MainTemplate extends Template {
  constructor(outputOptions) {
    ...
    this.plugin("require-extensions", (source, chunk, hash) => {
      ...
      if(pkgOption('custom-public-path').value){
        buf.push(`${this.requireFn}.p = ${pkgOption('custom-public-path').value};`);
      } else {
